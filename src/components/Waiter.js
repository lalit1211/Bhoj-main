...
//         const res = await axios.put(`https://bhoj-server.herokuapp.com/api/orders/statusUpdate/${orderId}`,
//             { "status": "completed" },
//             {headers: {token: token}}
//         );
...
//         const res = await axios.get(`https://bhoj-server.herokuapp.com/api/orders/getOrders`,
//             {headers: {token: token}},
//             );
//         setOrders(res.data);
//         if(res.data !== null) {
